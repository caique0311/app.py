...
-   Falta de pergunta --- 400
-   Falha na API Gemini --- código retornado pela API
-   Resposta inesperada --- 500
-   Erros internos --- 500
...
-   Corrigir os.getenv() para buscar o nome correto da variável
-   Remover caminho absoluto do .env
